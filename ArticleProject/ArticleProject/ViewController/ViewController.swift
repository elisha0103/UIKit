...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        model.delegate = self
        model.request = HeadlineArticleRequest(country: "kr", page: 1)
        model.getArticles()
        /*
    ...
    @objc func refreshTable(refresh: UIRefreshControl) {
        ...
        let headlineArticleRequest: HeadlineArticleRequest = HeadlineArticleRequest(country: "kr", page: 1)
        model.delegate = self
        model.request = headlineArticleRequest
        model.getArticles()
        refresh.endRefreshing()
